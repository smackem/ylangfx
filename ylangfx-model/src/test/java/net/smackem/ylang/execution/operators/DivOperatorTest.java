...
public class DivOperatorTest {
    ...
    public void divideNumberByNumber() throws MissingOverloadException {
        assertThat(BinaryOperator.DIV.invoke(Context.EMPTY,
                new NumberVal(100f), new NumberVal(10f)))
    ...
    public void divideRgbByNumber() throws MissingOverloadException {
        assertThat(BinaryOperator.DIV.invoke(Context.EMPTY,
                new RgbVal(20f, 30f, 40f, 50f), new NumberVal(10f)))
    ...
    public void divideRgbByRgb() throws MissingOverloadException {
        assertThat(BinaryOperator.DIV.invoke(Context.EMPTY,
                new RgbVal(20f, 30f, 40f, 50f), new RgbVal(127.5f, 127.5f, 127.5f, 127.5f)))
    ...
    public void throwsOnMissingOverload() {
        ...
        assertThatThrownBy(() -> BinaryOperator.DIV.invoke(Context.EMPTY,
                NumberVal.ONE, RgbVal.EMPTY))
