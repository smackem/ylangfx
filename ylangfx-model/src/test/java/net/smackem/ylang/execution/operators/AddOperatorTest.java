...
public class AddOperatorTest {
    ...
    public void numberPlusNumber() throws MissingOverloadException {
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new NumberVal(100f), new NumberVal(50f)))
    ...
    public void pointPlusNumber() throws MissingOverloadException {
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new PointVal(100f, 200f), new NumberVal(50f)))
                .isEqualTo(new PointVal(150f, 250f));
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new NumberVal(50f), new PointVal(100f, 200f)))
                .isEqualTo(new PointVal(150f, 250f));
    }
    ...
    public void pointPlusPoint() throws MissingOverloadException {
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new PointVal(100f, 200f), new PointVal(50f, 20f)))
    ...
    public void rgbPlusNumber() throws MissingOverloadException {
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new RgbVal(10f, 20f, 30f, 40f), new NumberVal(50f)))
                .isEqualTo(new RgbVal(60f, 70f, 80f, 40f));
        assertThat(BinaryOperator.ADD.invoke(Context.EMPTY,
                new NumberVal(50f), new RgbVal(10f, 20f, 30f, 40f)))
                .isEqualTo(new RgbVal(60f, 70f, 80f, 40f));
    }

    @Test
    public void throwsOnMissingOverload() {
        assertThatThrownBy(() -> BinaryOperator.ADD.invoke(Context.EMPTY,
                NumberVal.ONE, RectVal.EMPTY))
                .isInstanceOf(MissingOverloadException.class);
        assertThatThrownBy(() -> BinaryOperator.ADD.invoke(Context.EMPTY,
                NilVal.INSTANCE, NumberVal.ONE))
                .isInstanceOf(MissingOverloadException.class);
    }
}
